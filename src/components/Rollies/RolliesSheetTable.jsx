...
function TimesheetTable({selectedDateRange,setSelectedDateRange,rollies,setRollies,fetch, setFetch,type}) {
  ...
  }, [selectedDateRange, rollies]);


  /*const handleStartTimeChange = (employeeIndex, date, time) => {
    const updatedTimesheetData = [...timesheetData];
    updatedTimesheetData[employeeIndex].dates[date].start = time.format('HH:mm');
