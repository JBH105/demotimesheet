...
function MaterialTimesheet({ selectedDateRange, material, items, fetch, setFetch, type }) {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-2 mb-4 space-x-1">
        <h1 className='font-bold text-black'>{type} From:</h1>
...
export default MaterialTimesheet;
