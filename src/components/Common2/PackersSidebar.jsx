...
const PackersSidebar = ({ collapsed, setCollapsed }) => {
  ...
  const items = [
    {
      ...
      icon: <HomeOutlined />,
      label: 'Home',
      path: '/materials/packers/home',
    },
    {
      key: '9',
      icon: <FormOutlined />,
      label: 'Packers Sheet',
      path: '/materials/packers/sheet',
    },
    {
      key: '4',
      icon: <FieldTimeOutlined />,
      label: 'Saved Packers',
      path: '/materials/packers/saved',
    }
  ];
